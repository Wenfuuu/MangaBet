...
<div class="flex flex-col items-center justify-center text-center px-6 py-20 min-h-[50vh]">
	<div
		class="w-14 h-14 rounded-full bg-accent/12 border border-accent/30 flex items-center justify-center mb-6"
	>
	...
	<p class="font-sans text-[15px] text-fg-soft mt-3 max-w-[440px]">
	...
	<button
		onclick={retry}
		disabled={retrying}
		class="mt-7 inline-flex items-center gap-2 px-5 py-3 bg-accent text-accent-on border-none rounded-lg font-sans text-sm font-semibold cursor-pointer disabled:opacity-60 disabled:cursor-wait"
	>
		<svg
			width="14"
			height="14"
